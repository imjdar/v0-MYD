      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 px-6 md:flex-row">
        <div className="flex-1">
          <h2 className="font-serif text-3xl font-bold leading-tight text-foreground md:text-5xl">
            {"!Esta es nuestra"}
            <br />
            <span className="text-primary">{"5ta Edicion!"}</span>
          </h2>
          <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground md:text-base">
            En la Feria Mueble y Decoracion celebramos la esencia del arte ecuatoriano en madera,
            trayendo lo mejor de la artesania, diseno y tradicion a Quito. Del 03 al 19 de abril de 2026.
          </p>
          <a
            href="#quienes-somos"
        ...
        <div className="relative flex-1">
          <div className="overflow-hidden rounded-xl shadow-xl">
            <Image
              ...
              alt="Inauguracion de la 5ta Edicion de la Feria Mueble y Decoracion"
              width={600}
              height={400}
